...
[**Transferring taste**](https://emilkowal.ski/ui/agents-with-taste#transferring-taste)
...
So take a step back, ask yourself why you made a certain decision, articulate clearly why something has to be done this way, set the rules, and be *strict*. To make this process easier, I use the [skill-creator](https://github.com/anthropics/skills/blob/main/skills/skill-creator/SKILL.md) skill from Anthropic.
